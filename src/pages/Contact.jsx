...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-deepestB via-slightlLB to-mediumB flex items-center justify-center px-4 py-10">
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-white text-center mb-10">Get in Touch with <span className="text-deepestB">MarketPlace</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full bg-gradient-to-r from-mediumB to-lightB text-white font-semibold py-2 rounded-xl hover:opacity-90 transition-all duration-300">
              Send Message 🚀
            </button>
          </form>
        </div>
